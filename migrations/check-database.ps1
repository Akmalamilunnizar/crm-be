...
Write-Host "Please run these SQL commands in your database tool:" -ForegroundColor Yellow
...
Write-Host "2. Test upload with: .\simple-upload-test.ps1" -ForegroundColor Yellow
