-- Update installation_report_complete view to filter out soft-deleted records
-- Run this query on the iqgncnzy_skripsi database

ALTER VIEW installation_report_complete AS
SELECT
...
WHERE ci.deleted_at IS NULL;  -- Only show records where deleted_at is NULL
